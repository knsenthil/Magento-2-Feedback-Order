...
class Edit extends Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Learning_Orderreview::feedback')
    ...
    public function execute()
    {
        ...
        if ($id) {
            $model->load($id);
            if (!$model->getId()) {
                $this->messageManager->addError(__('This Feedback not exists.'));
        ...
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getOrderId() : __('New Feedback'));
